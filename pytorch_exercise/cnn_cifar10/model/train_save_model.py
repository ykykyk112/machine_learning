...
def train_eval_model_gpu(model, epoch, device, train_loader, test_loader, cam_mode, save_path = None) :
    ...
    for i in range(epoch) :
        ...
        for idx, (train_data, train_target) in enumerate(train_loader) :
            ...
            sum_loss = (t_loss*(1.0) + b_loss*(0.25) + e_loss*(0.25))
            sum_loss.backward()
    ...
    torch.save(best_boundary_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_boundary_relu_vgg19_2048_1_25_2.pth')
    torch.save(best_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_ensemble_relu_vgg19_2048_1_25_2.pth')
...
def train_eval_model_gpu_cam(model, epoch, device, train_loader, test_loader, cam_mode, save_path = None) :
    ...
    torch.save(best_acc_parameter, './ImageNet/ImageNet_sum_210701/baseline_best_accuracy_vgg19.pth')
    #torch.save(best_loss_parameter, './ImageNet/target_imagenet_subset_48.pth')
