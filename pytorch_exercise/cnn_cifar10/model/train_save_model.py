...
def train_eval_model_gpu(model, epoch, device, train_loader, test_loader, cam_mode, save_path = None) :
    ...
    torch.save(best_boundary_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_boundary_relu_vgg19_2048_1_25.pth')
    torch.save(best_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_ensemble_relu_vgg19_2048_1_25.pth')
