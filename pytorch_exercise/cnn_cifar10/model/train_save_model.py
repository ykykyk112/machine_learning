...
def train_eval_model_gpu(model, epoch, device, train_loader, test_loader, cam_mode, save_path = None) :
    ...
    for i in range(epoch) :
        ...
        for idx, (train_data, train_target) in enumerate(train_loader) :
            ...
            sum_loss = (t_loss*(2.0) + b_loss*(0.5) + e_loss*(0.5))
            sum_loss.backward()
    ...
    torch.save(best_boundary_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_boundary_relu_vgg19_2048_2_0.pth')
    torch.save(best_loss_parameter, './ImageNet/ImageNet_sum_210707/separated_ensemble_relu_vgg19_2048_2_0.pth')
