    ...
    def forward(self, x, heatmap):
        ...
        if self.comp_mode == 'C' or self.comp_mode == 'c':
            ...
            with torch.no_grad():
                ...
                h_max = torch.amax(heatmap_upsample, dim = (1, 2, 3))
                h_min = torch.amin(heatmap_upsample, dim = (1, 2, 3))
                heatmap_rescaled = (heatmap_upsample-h_min) / (h_max / h_min)
            print(torch.amax(heatmap_rescaled, dim = (1, 2, 3)))
            print('\n\n\n')
