...
def drive():
    ...
    print('target model, ensemble-fc-layer : 2048, 2.0-weight on backbone, 0.5-weight on boundary & ensemble, concat on feature-map, relu on concat')
    print('VGG19 based model / ImageNet subset (55 classes, train image : 71159, test_image : 2750)')
    print('saved as separated_ensemble_relu_vgg19_2048_2_0.pth')
