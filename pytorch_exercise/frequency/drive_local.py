...
def drive():
    ...
    print('target model, ensemble-fc-layer : 1024, 0.5-weight on boundary & ensemble, concat on feature-map, relu on concat, ImageNet subset (55 classes, train image : 71159, test_image : 2750)')
