...
chrome_path = 'C:\\Users\ykyky\python_code\ML\image_crawler\chromedriver_win32\chromedriver.exe'
...
class Crawler_GUI() :
    ...
    def __init__(self) :
        ...
        # Image label 생성
        icon_naver = PhotoImage(file = 'C:\\Users\ykyky\python_code\ML\image_crawler\img_src\\naver.jpg').subsample(26)
        icon_google = PhotoImage(file = 'C:\\Users\ykyky\python_code\ML\image_crawler\img_src\google.jpg').subsample(25)
        icon_daum = PhotoImage(file = 'C:\\Users\ykyky\python_code\ML\image_crawler\img_src\daum.jpg').subsample(18)
        icon_download = PhotoImage(file = 'C:\\Users\ykyky\python_code\ML\image_crawler\img_src\download.jpg').subsample(12)
